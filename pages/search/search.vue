				...
				<block v-if="searchType===1">
					<view class="search-history">
						<view class="search-history-head">
							<text>历史记录</text>
							<text class="iconfont icon-changyonggoupiaorenshanchu" @tap="handleToClear"></text>
						</view>
					...
					<view class="search-hot">
						...
						<view class="search-hot-word">
							<view class="">少年 <image src="../../static/dujia.png" mode="aspectFit"></image>
							</view>
							<view class="">"少年"这个词实在是太美了</view>
						</view>
						<text class="search-hot-count">296844</text>
					</view>
					<view class="search-hot-item">
						<view class="search-hot-top">1</view>
						<view class="search-hot-word">
...
<style scoped>
	...
	.search-suggest-title{color: #4574a5;margin-bottom: 74rpx;}
