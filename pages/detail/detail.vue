			...
			<scroll-view scroll-y="true">
				...
				<view class="detail-lyric">
					<view class="detail-lyric-wrap" :style="{transform:'translateY('+ -(lyricIndex - 1)*82 +'rpx)'}">
						...
						<!-- <view class="detail-lyric-item active">测试文字测试文字测试文字</view>
						<view class="detail-lyric-item">测试文字测试文字测试文字测试文字</view> -->
					</view>
				</view>
				...
				<view class="detail-comment">
					...
					<!-- <view class="detail-comment-item">
						...
						<view class="detail-comment-content">
							<view class="detail-comment-title">
								<view class="detail-comment-name">
									<view class="">是阿冗的冗啊</view>
									<view class="">2020年1月2日</view>
								</view>
								<view class="detail-comment-like">56017 <text class="iconfont icon-dianzan"></text>
								</view>
							</view>
							<view class="detail-comment-text">
